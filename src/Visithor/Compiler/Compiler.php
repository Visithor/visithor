...
class Compiler
{
    ...
    {
        $pharFilePath = dirname(__FILE__) . '/../../../build/visithor.phar';
         ...
         */
        $phar = new Phar($pharFilePath, 0, 'visithor.phar');
...
Phar::mapPhar('visithor.phar');

require 'phar://visithor.phar/bin/visithor';
